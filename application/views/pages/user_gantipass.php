              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-2">Ubah Password Anda?</h1>
                    <p class="mb-4">Jika password diubah, maka password lama akan digantikan dengan password baru!</p>
                  </div>
                  <form class="user" action="<?= base_url('Public_site/logout_re');?>">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="pass" name="pass_lama" placeholder="Password Lama" required>
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="pass_new" name="pass_baru" placeholder="Password Baru" required>
                    </div>
