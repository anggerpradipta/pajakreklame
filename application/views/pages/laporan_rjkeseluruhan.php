        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Daftar Reklame Keseluruhan</h6>
            </div>
            <div class="card-body" width="100%">
              ...
              <div class="table-responsive" style="padding-left: 5%; padding-right: 5%;">
                ...
                <div align="right" style="margin-top: 50px;">
                  <hr/>
                  <a href="<?= base_url('Core_actor/printRLkeseluruhan/');?>" target="_blank" class="btn btn-primary btn-icon-split">
                    <span class="icon text-white-50">
