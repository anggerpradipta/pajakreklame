        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Laporan Sewa Dan Pajak Reklame Per-Periode</h6>
            </div>
            <div class="card-body" width="100%">
              ...
              <div class="table-responsive" style="padding-left: 5%; padding-right: 5%;">
                <form action="<?= base_url('Core_actor/lapPJperiode');?>" method="post">
                  <div class="form-group">
                    <div class="input-group" style="width: 50%;">
                      <span class="input-group-addon" style="padding-top: 6px;">LAPORAN : </span>&nbsp;&nbsp;&nbsp;
                        <input type="date" name="tgl1" class="form-controll">&nbsp;&nbsp;&nbsp; - Sampai - &nbsp;&nbsp;&nbsp;<input type="date" name="tgl2" class="form-controll">
                ...
                <div align="right" style="margin-top: 50px;">
                  ...
                  <form action="<?= base_url('Core_actor/printPJperiode');?>" method="post">
                    <div class="form-group">
                      <div class="input-group" style="width: 60%;">
                        <span class="input-group-addon" style="padding-top: 6px;">LAPORAN : </span>&nbsp;&nbsp;&nbsp;
                          <input type="date" name="tgl1" class="form-controll">&nbsp;&nbsp;&nbsp; - Sampai - &nbsp;&nbsp;&nbsp;<input type="date" name="tgl2" class="form-controll">
                        <button type="submit" class="btn btn-primary" style="margin-left: 10px;"><i class="fas fa-print"></i> Print</button>
                      </div>
                  </form>
                </div>
              </div>
